"""Pydantic schemas for Dashlane Business Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Dashlane Business.")
    api_key: str = Field(description="Enterprise API Key / Access Token")
    base_url: str = Field(default="https://api.dashlane.com/v1", description="Dashlane Business API base URL.")
...
class GetVaultItemParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    vaultitem_id: str = Field(description="Dashlane Business VaultItem ID.")

"""Settings panel for Dashlane Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__dashlane_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=dashlane_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_dashlane"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Dashlane Settings & Accounts", level=2),

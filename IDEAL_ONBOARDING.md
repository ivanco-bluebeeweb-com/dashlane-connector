# Dashlane Connector — Ideal Onboarding & First Launch

**Compliance:** ONBOARDING_FIRST_LAUNCH_STANDARD.md

## Шаги онбординга
1. **Экран первого запуска:** Назначение коннектора Dashlane и требования к правам доступа.
2. **Ввод учетных данных:** Форма с явными лейблами, валидацией формата и подсказкой для получения ключа.
3. **Проверка подключения:** Немедленный вызов `GET /v1/team/members` с отображением статуса.

# PST Testing Scenarios for Dashlane Business Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_dashlane_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_dashlane_connector` without lingering secrets.
